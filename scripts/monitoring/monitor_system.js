...
function checkSystemStatus() {
  const checks = {
    ...
    'Archivo principal': fs.existsSync('api/twilio-call-improved.js') ? '✅ Existe' : '❌ No existe',
    'Librería BD': fs.existsSync('lib/database.js') ? '✅ Existe' : '❌ No existe',
    'Documentación': fs.existsSync('docs/') ? '✅ Existe' : '❌ No existe'
  };
